...
Module.prototype._normalizeDescriptor = function(rawModule, annotations) {
  var self = this;
  annotations = _.isObject(annotations) ? _.clone(annotations) : {};

  annotations.provides = self._normalizeProviderDesc(annotations.provides);
...
Module.prototype.setData = function(data) {
  ...
  if(data.annotations || !this.annotations) {
    this.annotations = this._normalizeDescriptor(this.rawModule, data.annotations);
  }
};


Module.prototype.getProvidesDescriptor = function(serviceName) {
  return this.annotations.provides[serviceName];
};
