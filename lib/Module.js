...
Module.prototype.getUnititializedModuleDependencies =  function(deps) {
  ...
  function addDep(dep) {
    if(self.isModuleDep(dep) && deps[dep] === void 0) {
  ...
  if(this.descriptor.initialize) {
    _.each(this.descriptor.initialize[0]);
  }
...
Module.prototype.getUnititializedModuleDependenciesDeep = function(deepDeps) {
  ...
  deepDeps = deepDeps || _.clone(newDeps);
...
Module.prototype.getModuleFromDep = function(name) {
  return this.container.getModuleFromDep(name);
};
