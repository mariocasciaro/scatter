...
Scatter.prototype.registerComponents = function() {
  return this.resolver.registerComponents.apply(this.resolver, arguments);
};

Scatter.prototype.registerComponent = function() {
  return this.resolver.registerComponents.apply(this.resolver, arguments);
};
